...
OPTIONAL_PROVIDER_DESCRIPTORS = {
    ...
    "marketdata_app": ConfiguredProvider("marketdata_app", "https://api.marketdata.app/v1", "Optional delayed US stocks/options provider; credit and personal-use limits apply."),
