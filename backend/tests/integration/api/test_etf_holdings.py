    ...
    assert body["legs"] == [
        {
            ...
            "history_route_status": "issuer_as_of_date",
            "history_route_provider": "ishares",
            "history_route_policy": "issuer_public_json_api_as_of_date",
            "history_route_source_url": "https://www.blackrock.com/varnish-api/blk-one01-product-data/product-data/api/v2/get-product-data",
            "message": None,
        },
        {
            "role": "value",
