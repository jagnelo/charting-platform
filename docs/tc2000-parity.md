...
while the existing unified-Python condition path remains available. The focused scan
suite proves the advanced tree is persisted through the canonical condition contract.
