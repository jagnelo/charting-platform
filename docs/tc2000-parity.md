...
## 2026-08-19 — Market Map visibly preserves hierarchy for every watchlist source
...
and does not regress into per-member linear lookup. Top-level group frames/counts are rendered as
