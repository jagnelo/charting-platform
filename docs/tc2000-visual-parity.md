...
## 2026-08-19 — Hierarchical geometry and group frames are the source-polymorphic interim oracle
...
Top-level group frames/counts are rendered as non-interactive HTML overlays for ordinary tile maps
and drawn directly into the large-universe canvas. This closes a functional hierarchy visibility
