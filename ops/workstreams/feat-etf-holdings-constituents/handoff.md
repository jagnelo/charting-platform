...
audit ledger currently has 85 queued fallback records still
...
provenance. Continue replacing baseline placeholders with first-party route
evidence, continuing with `fcf_advisors`, and checkpoint
