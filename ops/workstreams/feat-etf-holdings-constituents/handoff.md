...
- Current code-derived state: 496 registered, 378 native/live-backed, 118
  fallback-only.
- Current fallback status split: 8 access-blocked, 101 discovery, 3
...
- `docs/etf-provider-universe.md` has been reconciled from code to the current
  496/378/118 snapshot; future updates must remain code-derived.
