...
describe('MarketMapTool', () => {
  ...
  it('surfaces canonical benchmark role readiness beside the Market Map', async () => {
    ...
    expect(readiness.get('[aria-label="Benchmark family canonical identity evidence"]').text()).toContain('availability available · status available · members 101 · placeholders 80 · weighted 101 (ready) · classified 21 (partial) · point-in-time supported · history incomplete · bars D1 21/101 analysis-ready · 21 covered · 1000 bars · floor 252 · range 2025-01-01 to 2026-06-30, W1 0/101 analysis-ready · 0 covered · 0 bars · floor 52, MN 0/101 analysis-ready · 0 covered · 0 bars · floor 24 · readiness partial (member_bar_history_incomplete) · route configured · sec · adapter sec_issuer_holdings · refresh partial · reason issuer endpoint unavailable · checked 2026-07-03 · failed 2026-07-04 · composition 2026-06-30 · entitlement verified · sec · probe passed · rev 7 · effective 2026-07-01 · review due 2026-10-01')
