...
describe('MarketMapTool', () => {
  ...
  it('surfaces canonical benchmark role readiness beside the Market Map', async () => {
    ...
    expect(readiness.text()).toContain('History: D1 21/101 ready · 21 covered · 1000 bars · floor 252 · W1 0/101 ready · 0 covered · 0 bars · floor 52 · MN 0/101 ready · 0 covered · 0 bars · floor 24')
