...
describe('MarketMapTool', () => {
  ...
  it('surfaces canonical benchmark role readiness beside the Market Map', async () => {
    ...
    expect(readiness.get('[aria-label="Benchmark family canonical identity evidence"]').text()).toContain('Cap weight SPY · verification not reported · adapter unmapped · snapshot 2026-06-30 · as-of 2026-07-01 · known 2026-07-02 · provenance issuer snapshot · source quality issuer_disclosed · completeness partial · rows 101 · resolved 21 · unresolved 80 · continuity gapped · 1 gap · max 76d · intervals 2026-03-31 to 2026-06-15 (76d) · capabilities classification=pending, history=partial, holdings=supported, weights=supported')
    expect(readiness.get('[aria-label="Benchmark family canonical identity evidence"]').text()).toContain('availability available · status available · members 101 · placeholders 80 · weighted 101 (ready) · classified 21 (partial) · point-in-time supported · history incomplete · bars D1 21/101 analysis-ready · 21 covered · 1000 bars · floor 252 · range 2025-01-01 to 2026-06-30, W1 0/101 analysis-ready · 0 covered · 0 bars · floor 52, MN 0/101 analysis-ready · 0 covered · 0 bars · floor 24 · readiness partial (member_bar_history_incomplete) · route configured · sec · adapter sec_issuer_holdings · history route sec filing reconstruction · sec · latest sec filing report on or before requested date · source https://data.sec.gov/submissions/CIK0001067839.json · refresh partial · reason issuer endpoint unavailable · checked 2026-07-03 · failed 2026-07-04 · composition 2026-06-30 · entitlement verified · sec · probe passed · rev 7 · effective 2026-07-01 · review due 2026-10-01')
