...
describe('MarketMapTool', () => {
  ...
  it('surfaces canonical benchmark role readiness beside the Market Map', async () => {
    ...
    expect(readiness.get('[aria-label="Benchmark family canonical identity evidence"]').text()).toContain('Cap weight SPY · verification not reported · adapter unmapped · source quality issuer_disclosed · completeness partial')
