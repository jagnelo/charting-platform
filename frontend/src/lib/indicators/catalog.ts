...
export const INDICATOR_CATALOG: IndicatorCatalogItem[] = [
  {
    ...
    defaultConfig: { type: 'sma', params: { period: 20 }, style: { color: '#ffb74d', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'main' },
  ...
  },
  {
    ...
    defaultConfig: { type: 'ema', params: { period: 50 }, style: { color: '#64b5f6', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'main' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'wma',
    ...
    defaultConfig: { type: 'wma', params: { period: 20 }, style: { color: '#a5d6a7', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'main' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'hma',
    ...
    defaultConfig: { type: 'hma', params: { period: 20 }, style: { color: '#a5d6a7', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'main' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'dema',
    ...
    defaultConfig: { type: 'dema', params: { period: 20 }, style: { color: '#ffb74d', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'main' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'tema',
    ...
    defaultConfig: { type: 'tema', params: { period: 20 }, style: { color: '#f48fb1', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'main' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'vwap',
    ...
    defaultConfig: { type: 'vwap', params: {}, style: { color: '#ce93d8', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'main' },
    params: [],
  },
  {
    type: 'avwap',
    ...
    defaultConfig: { type: 'avwap', params: { anchor_timestamp: nowMinus30d() }, style: { color: '#80cbc4', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'main' },
  ...
  },
  {
    ...
    defaultConfig: { type: 'bb', params: { period: 20, std_dev: 2 }, style: { color: '#80cbc4', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'main' },
  ...
  },
  {
    ...
    defaultConfig: { type: 'keltner', params: { period: 20, atr_period: 10, multiplier: 2 }, style: { color: '#ce93d8', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'main' },
  ...
  },
  {
    ...
    defaultConfig: { type: 'donchian', params: { period: 20 }, style: { color: '#80deea', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'main' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'ichimoku',
    ...
    defaultConfig: { type: 'ichimoku', params: { tenkan: 9, kijun: 26, senkou_b: 52, displacement: 26 }, style: { color: '#80cbc4', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'main' },
    params: [
  ...
  },
  {
    ...
    defaultConfig: { type: 'psar', params: { af_start: 0.02, af_step: 0.02, af_max: 0.2 }, style: { color: '#ef9a9a', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'main' },
  ...
  },
  {
    ...
    defaultConfig: { type: 'pivot_points', params: { method: 'classic' }, style: { color: '#80cbc4', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'main' },
  ...
  },
  {
    ...
    defaultConfig: { type: 'rsi', params: { period: 14 }, style: { color: '#ef9a9a', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'separate' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'macd',
    ...
    defaultConfig: { type: 'macd', params: { fast: 12, slow: 26, signal: 9 }, style: { color: '#ef5350', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'separate' },
  ...
  },
  {
    ...
    defaultConfig: { type: 'stoch', params: { k_period: 14, d_period: 3, smooth_k: 3 }, style: { color: '#a5d6a7', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'separate' },
  ...
  },
  {
    ...
    label: 'ADX',
    pickerLabel: 'ADX / DMI',
    defaultConfig: { type: 'adx', params: { period: 14 }, style: { color: '#fff59d', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'separate' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'aroon',
    ...
    defaultConfig: { type: 'aroon', params: { period: 25 }, style: { color: '#81d4fa', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'separate' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'cci',
    ...
    defaultConfig: { type: 'cci', params: { period: 20 }, style: { color: '#f48fb1', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'separate' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'williams_r',
    ...
    defaultConfig: { type: 'williams_r', params: { period: 14 }, style: { color: '#ffcc80', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'separate' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'mfi',
    ...
    defaultConfig: { type: 'mfi', params: { period: 14 }, style: { color: '#f48fb1', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'separate' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'roc',
    ...
    defaultConfig: { type: 'roc', params: { period: 10 }, style: { color: '#ffb74d', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'separate' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'momentum',
    ...
    defaultConfig: { type: 'momentum', params: { period: 10 }, style: { color: '#b39ddb', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'separate' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'stddev',
    ...
    defaultConfig: { type: 'stddev', params: { period: 20 }, style: { color: '#fff59d', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'separate' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'cmf',
    ...
    defaultConfig: { type: 'cmf', params: { period: 20 }, style: { color: '#80deea', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'separate' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'obv',
    ...
    defaultConfig: { type: 'obv', params: {}, style: { color: '#81d4fa', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'separate' },
    params: [],
  },
  {
    type: 'atr',
    ...
    defaultConfig: { type: 'atr', params: { period: 14 }, style: { color: '#ffcc80', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'separate' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'trix',
    label: 'TRIX',
    pickerLabel: 'TRIX',
    defaultConfig: { type: 'trix', params: { period: 15 }, style: { color: '#a5d6a7', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'separate' },
    params: [{ key: 'period', label: 'Period' }],
  },
  {
    type: 'ppo',
    ...
    defaultConfig: { type: 'ppo', params: { fast: 12, slow: 26 }, style: { color: '#ce93d8', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'separate' },
  ...
  },
  {
    ...
    defaultConfig: { type: 'volume', params: {}, style: { color: '#4db6ac', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'main' },
    params: [],
  },
  {
    type: 'volume_ratio',
    ...
    defaultConfig: { type: 'volume_ratio', params: { period: 20 }, style: { color: '#4db6ac', lineWidth: DEFAULT_LINE_WIDTH }, pane: 'separate' },
