<template>
  <section ref="studyLabRoot" class="study-lab-tool">
    ...
    <details class="study-lab-tool__sdk-reference">
      ...
      <span><b>stats</b>: positive_close_streaks, streaks, mean, median, std, percentile, ranks, rolling, correlation, regression, distribution</span><span><b>research</b>: forward_returns, conditional_outcomes, regimes, historical_comparison, occurrences, cross_sectional_rank, breadth_snapshot</span>
