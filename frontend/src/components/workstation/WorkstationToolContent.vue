<template>
  <ToolWindow :title="tool.title || tool.tool_type" :symbol="activeSymbol" :link-group="tool.link_group" :active="tool.instance_key === activeWindowKey" @update:link-group="emit('updateLinkGroup', tool.instance_key, $event)">
